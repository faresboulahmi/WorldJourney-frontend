          ...
          <div className="flex flex-col w-full  m-auto relative bg-[#F7F8FC]">
            ...
            <div className=" relative flex flex-col justify-center">
              {currentUser && currentUser.role !== "MainAdmin" && (
                <form
                  className="max-w-6xl rounded-lg h-60 sm:h-46 lg:h-40 w-full mb-4 sm:w-[70%] relative p-4 sm:px-20 flex flex-col justify-center gap-8 bg-orange-500 m-auto md:py-[120px] "
                  onSubmit={() => showSuccessMessage("success subscribe")}
                >
                  <img
                    src={PalmTree}
                  ...
                  <img
                    src={Circle}
                    className="w-40 absolute bottom-0 left-0 hidden sm:inline"
                    alt="circle"
                  />
                  ...
                  <div className="flex flex-col sm:flex-row gap-2  justify-between items-center w-full bg-white rounded-lg p-1">
                    <div className="text-gray-300 flex flex-row justify-center items-center">
                      ...
                      <input
                        ...
                        required
                        className="outline-none w-full text-slate-700 hover:font-semibold"
                      />
                    </div>
                    <button
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-between">
                      <div className="flex flex-col gap-2">
                        ...
                        <div className="text-sm">
                          Book your trip in minute , <br /> get full Control for
                          much longer.
                        </div>
                        <div className="flex flex-row gap-2 ">
                          <Link
                            to={`https://github.com/faresboulahmi`}
                            target="_blanket"
                            aria-label="github"
                          >
                            <div className="bg-white rounded-full flex justify-center items-center hover:bg-orange-500 h-6 w-6 hover:text-white transition-all">
                              <FaGithub />
                            </div>
                          </Link>
                          <Link
                            to={`https://www.linkedin.com/in/fares-boulahmi-342b61268/`}
                            target="_blanket"
                            aria-label="linkedIn"
                          >
                            <div className="bg-white rounded-full flex justify-center items-center hover:bg-orange-500 h-6 w-6 hover:text-white transition-all">
                          ...
                          <Link
                            to={`https://twitter.com/BoulahmiFares`}
                            target="_blanket"
                            aria-label="twitter"
                          >
                            <div className="bg-white rounded-full flex justify-center items-center hover:bg-orange-500 h-6 w-6 hover:text-white transition-all">
